...
- IFC: **PASS**.
- Fitted landmarks: **PASS**, RMS **2.19 px**, maximum **3.12 px**, tolerance **5 px**.
...
Reference image supplied by the project author for this development run. Original creator and redistribution terms have not been documented. The original image is omitted from this public snapshot pending source confirmation; generated output and measurement evidence are included.
